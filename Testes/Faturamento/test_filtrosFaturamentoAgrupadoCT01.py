...
def validacaoFiltroFaturamentoAgrupadoContratos01a136(page):
    ...
    expect(faturamentocontratoagrupado.gripPrincialContratos).to_have_text(
            '98 - EMPRESA USADA EM TESTE AUTOMATIZADO DE CONTRATO TRF: #2051010Contrato 1Não InformadoCond. Pgto 1 - Testes Katia Filtros Faturamento  '
